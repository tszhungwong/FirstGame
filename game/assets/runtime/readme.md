...
Every runtime media file added here must have a separate entry in `docs/assets/asset-register.csv`; runtime images larger than 2048×2048 are rejected by validation.
